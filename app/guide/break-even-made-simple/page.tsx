...
export default function GuidePage() {
  const pageUrl = "https://www.fosterwealthventures.com/guide/break-even-made-simple";
  ...
  return (
    <main className="prose prose-brand mx-auto max-w-3xl px-6 py-10">
      ...
      <section>
        <h2>Quick Summary</h2>
        <p>Understand break-even analysis and how to calculate the units needed to cover costs and reach profitability.</p>
      </section>

      <section>
        <CTAButton href="/?calc=break-even">👉 Try the matching calculator</CTAButton>
      </section>
      ...
      <div className="mt-6 not-prose">
        ...
        <title>Break-Even Made Simple—Use Our Calculator to Master Costs & Profit Margins</title>
      </div>
