...
export async function POST(req: Request) {
  try {
    ...
    const calcLinkByName: Record<string, string> = {
      'Credit Utilization Optimizer': '/credit-utilization',
      'Debt Payoff Priority Ranker': '/debt-payoff-priority',
      'Real Estate Deal Snapshot Calculator': '/deal-snapshot',
      'Max Offer & ARV Calculator': '/max-offer-arv',
      'Tip & Tab Split Calculator': '/tip-split',
    };
    ...
    const guideByCalc: Record<string, string> = {
      'Credit Utilization Optimizer': '/guide/credit-utilization',
      'Debt Payoff Priority Ranker': '/guide/debt-payoff-priority',
      'Real Estate Deal Snapshot Calculator': '/guide/real-estate-deal-snapshot',
      'Max Offer & ARV Calculator': '/guide/max-offer-arv',
      'Tip & Tab Split Calculator': '/guide/tip-and-tab-split',
    };
...
- Make ${mainCalculator} the HERO calculator - users should finish reading knowing exactly how to use it` : '';
    ...
    const systemPrompt = `You are a senior financial content writer creating comprehensive, practical guides for Foster Wealth Calculators, a site focused on credit, debt payoff, and real estate investing calculators.
...
- Clear explanations of credit, debt payoff, or real estate investing concepts
...
- NEVER recommend: Loan Calculator, Personal Loan Calculator, ROI Calculator, Mortgage Calculator, Savings Growth Calculator, or any calculator not listed above
- Use the exact calculator URL when possible, such as [Credit Utilization Optimizer](/credit-utilization) or [Real Estate Deal Snapshot Calculator](/deal-snapshot)
- Credit articles should naturally lead toward Credit Insight Intelligence; real estate articles should naturally lead toward HavenMIND
...
2. Practical examples from credit payoff or real estate investing
...
## Next Steps
Use our calculators at [/calculators](/calculators) to run specific calculations for your situation. Start with the [Credit Utilization Optimizer](/credit-utilization), [Debt Payoff Priority Ranker](/debt-payoff-priority), [Real Estate Deal Snapshot Calculator](/deal-snapshot), or [Max Offer & ARV Calculator](/max-offer-arv).
