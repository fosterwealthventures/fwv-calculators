...
export default function BlogGeneratorDevUI() {
  ...
  const [ctaVariant, setCtaVariant] = React.useState<'calculators'>('calculators');
  ...
  const [options, setOptions] = React.useState<GenOptions>({
    ...
    targetCalculators: ['Credit Utilization Optimizer', 'Debt Payoff Priority Ranker', 'Real Estate Deal Snapshot Calculator', 'Max Offer & ARV Calculator'],
    mainCalculator: '',
    intent: '',
    keywords: [],
    meta_description: '',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g., How to lower credit utilization before applying for a loan"
            value={topic}
        ...
        <div>
          ...
          >
            ...
            <optgroup label="Credit Calculators">
              <option value="Credit Utilization Optimizer">Credit Utilization Optimizer</option>
              <option value="Debt Payoff Priority Ranker">Debt Payoff Priority Ranker</option>
            </optgroup>

            <optgroup label="Real Estate Calculators">
              <option value="Real Estate Deal Snapshot Calculator">Real Estate Deal Snapshot Calculator</option>
              <option value="Max Offer & ARV Calculator">Max Offer & ARV Calculator</option>
            </optgroup>
          ...
          <div className="mt-1 text-xs text-gray-500">
            Choose which calculator to feature prominently. The generator is now focused on credit, debt payoff, and real estate investing.
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mb-8">
        <div className={`border rounded p-6 ${intent.trim() && !isIntentValid ? 'border-red-300 bg-red-50' : ''}`}>
          ...
          <textarea
            ...
            placeholder="e.g., Users want to understand which card to pay first and why utilization matters"
            value={intent}
        ...
        <div className="border rounded p-6">
          ...
          <input
            ...
            placeholder="credit utilization, debt payoff, rental cash flow, ARV, DSCR"
            value={keywords}
        ...
        <div className={`border rounded p-6 ${metaDescription.trim() && !isMetaDescriptionValid ? 'border-red-300 bg-red-50' : ''}`}>
          ...
          <textarea
            ...
            placeholder="A practical guide to credit utilization, debt payoff, or real estate deal analysis with calculator examples."
...
• Data-driven & concise, focusing on actionable metrics and calculations"
      ...
      <div className="mb-6 border rounded p-4">
        ...
        <div className="mt-4">
          ...
          <input
            className="w-full border rounded px-3 py-2"
            placeholder="Credit Utilization Optimizer, Debt Payoff Priority Ranker, Real Estate Deal Snapshot Calculator, Max Offer & ARV Calculator"
      ...
      <div className="mt-10 border rounded">
        ...
        <div className="p-4">
          ...
          <textarea
            ...
            placeholder="How to lower credit utilization before applying for a loan\nDebt snowball vs avalanche for credit card payoff\nHow to analyze rental property cash flow\nHow to calculate ARV and max offer"
            value={bulkText}
