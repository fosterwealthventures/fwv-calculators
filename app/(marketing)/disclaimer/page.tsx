...
export default function DisclaimerPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-4 leading-7">
        We may link to or integrate third-party services, such as analytics,
        email delivery, or related Foster Wealth Ventures services. We are not
        responsible for their content, policies, or availability. Your use of
        third-party services is governed by their terms and privacy policies.
      </p>

      <h2 className="mt-10 text-2xl font-semibold">External Links</h2>
      <p className="mt-4 leading-7">
        Some calculators and guides may link to related Foster Wealth Ventures
        resources. Those links do not influence our calculator formulas or
        outputs.
      </p>
