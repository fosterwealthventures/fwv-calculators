...
<p className="mt-8">
  <a href="/" className="underline text-brand-green">Home</a>
</p>
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-6 leading-7">
        Welcome to Foster Wealth Calculators. By accessing or using our
        website, calculators, guides, and related content (the “Service”),
      ...
      <h2 className="mt-10 text-2xl font-semibold">2) Accounts &amp; Subscriptions</h2>
      <p className="mt-4 leading-7">
      ...
      <p className="mt-4 leading-7">
        Do not abuse, interfere with, or reverse engineer the Service. We
        may suspend or terminate access for violations of these Terms or
        for activity that disrupts or harms the Service or other users.
      </p>
      ...
      <h2 className="mt-10 text-2xl font-semibold">5) Ads &amp; Affiliate Links</h2>
      <p className="mt-4 leading-7">
      ...
      <h2 className="mt-10 text-2xl font-semibold">6) Disclaimers &amp; Limitation of Liability</h2>
      <p className="mt-4 leading-7">
        The Service is provided “as is,” without warranties of any kind.
        To the fullest extent permitted by law, Foster Wealth Ventures and
        its contributors are not liable for any losses or damages arising
        from use of the Service.
      </p>

      <h2 className="mt-10 text-2xl font-semibold">7) Changes to These Terms</h2>
      <p className="mt-4 leading-7">
      ...
      <p className="mt-10 text-sm text-gray-600">Effective date: {EFFECTIVE_DATE}</p>
    </main>
  );
}
