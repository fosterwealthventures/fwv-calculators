    ...
    <main className="mx-auto max-w-3xl px-4 py-10 space-y-6">
      ...
      <section className="space-y-3 text-gray-700">
        ...
        <ul className="list-disc ml-6">
          ...
          <li>Understand site performance and improve visitor experience</li>
        </ul>

        <h2 className="text-xl font-semibold text-brand-green">Cookies & Analytics</h2>
        <p>
          We may use privacy-conscious analytics cookies or similar technologies
          to understand site performance and improve the calculators. You can
          manage your choices via our consent banner.
        </p>

        <h2 className="text-xl font-semibold text-brand-green">Your Choices</h2>
        <ul className="list-disc ml-6">
          <li>Use the on-site consent banner to accept or reject analytics cookies</li>
