...
export default function Header() {
  ...
  return (
    <header data-site-header className="header-regal sticky top-0 z-40 border-b border-plum-800 bg-plum-900 text-white">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          <div className="relative inline-flex items-center" ref={dropdownRef}>
            ...
            {calcOpen && (
              <div className="absolute right-0 top-full z-50 mt-2 min-w-[280px] max-h-[70vh] overflow-y-auto rounded-xl border border-neutral-200 bg-white text-neutral-900 shadow-xl p-2 pointer-events-auto">
          ...
          {NAV_LINKS.map((link) => (
            <Link key={link.href} href={link.href} className="nav-link-regal text-white/90 hover:text-white">
              {link.label}
            </Link>
          ))}
        </nav>
